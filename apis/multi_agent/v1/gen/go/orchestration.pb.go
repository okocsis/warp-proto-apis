...
type OrchestrationConfig_Remote struct {
	...
	xxx_hidden_RunnerId      *string                `protobuf:"bytes,3,opt,name=runner_id,json=runnerId"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *OrchestrationConfig_Remote) GetRunnerId() string {
	if x != nil {
		if x.xxx_hidden_RunnerId != nil {
...
func (x *OrchestrationConfig_Remote) SetRunnerId(v string) {
...
func (x *OrchestrationConfig_Remote) HasRunnerId() bool {
	if x == nil {
		return false
	}
...
func (x *OrchestrationConfig_Remote) ClearRunnerId() {
...
const file_orchestration_proto_rawDesc = "" +
	...
	"workerHost\x12\x1b\n" +
	"\trunner_id\x18\x03 \x01(\tR\brunnerIdB\x10\n" +
