...
func (x *InputContext_Git_Repository) GetHost() string {
	if x != nil {
...
func (x *InputContext_Git_Repository) SetHost(v string) {
	x.xxx_hidden_Host = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 2, 3)
}
...
func (x *InputContext_Git_Repository) HasHost() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 2)
...
func (x *InputContext_Git_Repository) ClearHost() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 2)
...
type InputContext_Git_Repository_builder struct {
	...
	Owner *string
	// The repository host, e.g. "github.com". Parsed from the origin remote.
	Host *string
}
...
func (x *InputContext_Git_PullRequest) GetUrl() string {
	if x != nil {
...
func (x *InputContext_Git_PullRequest) SetUrl(v string) {
	x.xxx_hidden_Url = &v
...
func (x *InputContext_Git_PullRequest) HasUrl() bool {
	if x == nil {
		return false
	}
...
func (x *InputContext_Git_PullRequest) ClearUrl() {
...
type InputContext_Git_PullRequest_builder struct {
	...
	BaseBranch *string
	// The full URL of the pull request, e.g.
...
const file_input_context_proto_rawDesc = "" +
	"\n" +
	"\x13input_context.proto\x12\x13warp.multi_agent.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a!google/protobuf/go_features.proto\x1a\x12file_content.proto\x1a\x10attachment.proto\x1a\roptions.proto\x1a\vskill.proto\x1a\tlsp.proto\"\x8e\x14\n" +
	"\fInputContext\x12I\n" +
	...
	"\x1aadditional_rule_file_paths\x18\x03 \x03(\tR\x17additionalRuleFilePaths\x1a\xf0\x04\n" +
	"\x03Git\x12\x18\n" +
	...
	"repository\x12T\n" +
	"\fpull_request\x18\x04 \x01(\v21.warp.multi_agent.v1.InputContext.Git.PullRequestR\vpullRequest\x1a\\\n" +
	"\n" +
	"Repository\x12\x18\n" +
	"\x04name\x18\x01 \x01(\tB\x04\x80\xb5\x18\x01R\x04name\x12\x1a\n" +
	"\x05owner\x18\x02 \x01(\tB\x04\x80\xb5\x18\x01R\x05owner\x12\x18\n" +
	"\x04host\x18\x03 \x01(\tB\x04\x80\xb5\x18\x01R\x04host\x1a\xaa\x02\n" +
	...
	"baseBranch\x12\x16\n" +
	"\x03url\x18\x05 \x01(\tB\x04\x80\xb5\x18\x01R\x03url\"h\n" +
	"\x05State\x12\x15\n" +
